...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('plano', function (Blueprint $table) {
            ...
            $table->integer('numero_passageiro');
            $table->longText('espe_viatura')->nullable();
            $table->bigInteger('km_prevista')->nullable();
            $table->string('alocar_viatura');
            $table->integer('qtd_combustivel') ;
