   ...
   <div class="row">
      <div class="col-md-12">
         <div class="card">
            ...
            <form class="theme-form mega-form" autocomplete="off" action="{{ route('ocorrencia.put', Crypt::encrypt($ocorrencia->id)) }}" method="POST">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                           <div class="mb-3 mb-0">
                              ...
                              <textarea class="form-control" name="descricao" rows="5">{{$ocorrencia->descricao}}</textarea>
                           </div>
                        ...
                        <div class="mb-3 col-md-4">
                            ...
                            <select class="js-example-basic-single col-sm-12" name="tipo">
                                ...
                                <option value="Informativa" {{($ocorrencia->tipo == 'Informativa') ? 'selected' : '' }}>Informativa</option>
                                <option value="Acção Necessária" {{($ocorrencia->tipo == 'Acção Necessária') ? 'selected' : '' }}>Acção Necessária</option>
                            </select>
                        ...
                        <div class="mb-3 col-md-4">
                           ...
                           <div class="input-group">
                              <input class="form-control digits" type="datetime-local" min="{{date('Y-m-d').'T'.date('00:00')}}" max="{{date('Y-m-d').'T'.date('H:i')}}" name="data_hora_ocorrencia" value="{{$ocorrencia->data_hora}}">
                           </div>
                        ...
                        <div class="mb-3 col-md-4">
                            ...
                            <select class="js-example-basic-single col-sm-12" name="motorista">
                                ...
                                @foreach ($motoristas as $motorista)
                                    <option value="{{$motorista->id}}" {{($ocorrencia->motorista_id == $motorista->id) ? 'selected' : ''}}>{{$motorista->nome . ' ' . $motorista->apelido}}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-3 col-md-4">
                            ...
                            <select class="js-example-basic-single col-sm-12" name="viatura" onchange="javascript:getViaturaInfo(this.value)">
                                ...
                                @foreach ($viaturas as $viatura)
                                    <option value="{{$viatura->id}}" {{($ocorrencia->viatura_id == $viatura->id) ? 'selected' : ''}}>{{$viatura->matricula}}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-3 col-md-4">
                            ...
                            <input class="form-control" type="number" min="0" name="kilometragem" id="kilometragem" value="{{$ocorrencia->odometro}}" placeholder="Digite a kilometragem da viatura" disabled>
