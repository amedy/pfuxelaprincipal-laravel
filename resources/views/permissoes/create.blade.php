   ...
   <div class="row">
      <div class="col-md-12">
         <div class="card">
            ...
            <form class="theme-form mega-form" autocomplete="off" action="{{ route('permissoes.store') }}" method="POST">
                @csrf
                <div class="card-body">
                        <div class="row">
                            <div class="mb-3 col-md-4">
                                <label class="col-form-label">Nome do grupo de permissões <span style="color: red">*</span></label>
                                <input class="form-control" type="text" name="nome_do_grupo" value="{{old('nome_do_grupo')}}" placeholder="Digite o nome do grupo de permissões">
