   ...
   <div class="row">
      <div class="col-md-12">
         <div class="card">
            ...
            <form class="theme-form mega-form" autocomplete="off" action="{{ route('tecnico.store') }}" method="POST">
                @csrf
                <div class="card-body">
                            ...
                            <div class="mb-3 col-md-4">
                                ...
                                <select class="js-example-basic-single col-sm-12" name="especialidade">
                                    ...
                                    @foreach ($especialidades as $especialidade)
                                        <option value="{{$especialidade->id}}" {{(old('especialidade') == $especialidade->id) ? 'selected' : ''}}>{{$especialidade->nome}}</option>
                                    @endforeach
                                </select>
