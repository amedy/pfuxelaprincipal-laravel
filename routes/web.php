...
use App\Http\Controllers\HSTRequisicaoController;
...
use App\Http\Controllers\PiqueteController;
...
//Route::post('rpiquete', [App\Http\Controllers\PiqueteController::class, 'store'])->name('rpiquete.store');
Route::prefix('rpiquete')->controller(PiqueteController::class)->group(function () {
        Route::get('criar', 'create')->name('rpiquete.create');
        Route::get('lista', 'index')->name('rpiquete.list');
        Route::post('registar', 'store')->name('rpiquete.store');
        Route::get('editar/{id}', 'update')->name('rpiquete.update');

});

//  Route::get('editar/{id}', 'editar')->name('rpiquete.editar');


Route::middleware(['auth', 'menus.access'])->group(function () {
    ...
    Route::prefix('motorista')->controller(MotoristaController::class)->group(function () {
        Route::get('criar', 'create')->name('motorista.create');
        Route::get('lista', 'index')->name('motorista.list');
        Route::get('editar/{id}', 'update')->name('motorista.update');
        Route::get('documentos/editar/{id}', 'updateDocs')->name('motorista.docs.update');
        Route::post('documentos/salvar/{carta_conducao}', 'putDocs')->name('motorista.docs.put')->withoutMiddleware('menus.access');
        Route::post('registar', 'store')->name('motorista.store')->withoutMiddleware('menus.access');
        Route::post('salvar/{id}', 'put')->name('motorista.put')->withoutMiddleware('menus.access');
        Route::post('eliminar/{id}', 'delete')->name('motorista.delete');
    });

    Route::prefix('rotas')->controller(RotasController::class)->group(function () {
        Route::get('criar', 'create')->name('rotas.create');
        Route::get('lista', 'index')->name('rotas.list');
        Route::post('registar', 'store')->name('rotas.store');
    });


    //Rota piquete

    Route::prefix('projectos')->controller(ProjectoController::class)->group(function () {
        Route::get('criar', 'create')->name('projectos.create');
        Route::get('lista', 'index')->name('projectos.list');
        Route::post('registar', 'store')->name('projectos.store');
    });

    Route::prefix('viatura')->controller(ViaturaController::class)->group(function () {
        Route::get('criar', 'create')->name('viatura.create');
        Route::get('lista', 'index')->name('viatura.list');
        Route::get('editar/{id}', 'update')->name('viatura.update');
        Route::get('getViaturaInfo', 'getViaturaInfo')->name('viatura.getViaturaInfo')->withoutMiddleware('menus.access');
        Route::get('switchObjective', 'switchObjective')->name('viatura.switchObjective')->withoutMiddleware('menus.access');
        Route::get('documentos/editar/{id}', 'updateDocs')->name('viatura.docs.update');
        Route::post('registar', 'store')->name('viatura.store')->withoutMiddleware('menus.access');
        Route::post('salvar/{id}', 'put')->name('viatura.put')->withoutMiddleware('menus.access');
        Route::post('documentos/salvar/{id}', 'putDocs')->name('viatura.docs.put')->withoutMiddleware('menus.access');
        Route::post('eliminar/{id}', 'delete')->name('viatura.delete');
    });

    Route::prefix('viatura')->controller(ViaturaController::class)->group(function () {
        Route::get('alocar/criar', 'createAlocar')->name('viatura.alocar.create');
        Route::get('alocar/lista', 'indexAlocar')->name('viatura.alocar.list');
        Route::get('alocar/historico', 'indexHistorico')->name('viatura.alocar.history');
        Route::get('alocar/editar/{id}', 'updateAlocar')->name('viatura.alocar.update');
        Route::post('alocar/registar', 'storeAlocar')->name('viatura.alocar.store')->withoutMiddleware('menus.access');
        Route::post('alocar/salvar/{id}', 'putAlocar')->name('viatura.alocar.put')->withoutMiddleware('menus.access');
        Route::post('alocar/eliminar/{id}', 'deleteAlocar')->name('viatura.alocar.delete');
    });

    Route::prefix('abastecimento')->controller(AbastecimentoController::class)->group(function () {
        Route::get('criar', 'create')->name('abastecimento.create');
        Route::get('extraordinario/criar', 'createExtra')->name('abastecimento.extra.create');
        Route::get('lista', 'index')->name('abastecimento.list');
        Route::get('detalhes/{id}', 'show')->name('abastecimento.show');
        Route::get('terminar/{id}', 'retrieve')->name('abastecimento.retrieve');
        Route::get('getFuelData', 'getFuelData')->name('viatura.getFuelData')->withoutMiddleware('menus.access');
        Route::get('getOther', 'getOther')->name('viatura.getOther')->withoutMiddleware('menus.access');
        Route::get('adicionar-ordem', 'addOrder')->name('abastecimento.addToOrdens')->withoutMiddleware('menus.access');
        Route::get('remover-ordem', 'removeOrder')->name('abastecimento.removeFromOrdens')->withoutMiddleware('menus.access');
        Route::post('registar', 'store')->name('abastecimento.store')->withoutMiddleware('menus.access');
        Route::post('extraordinario/registar', 'storeExtra')->name('abastecimento.extra.store')->withoutMiddleware('menus.access');
        Route::post('cancelar/{id}', 'cancel')->name('abastecimento.cancel');
        Route::post('autorizar/{id}', 'approve')->name('abastecimento.approve');
        Route::post('eliminar/{id}', 'delete')->name('abastecimento.delete')->withoutMiddleware('menus.access');
    });

    Route::prefix('movimentos')->controller(ViaturaController::class)->group(function () {
        Route::get('criar', 'create')->name('movimentos.create');
        Route::get('lista', 'index')->name('movimentos.list');
        Route::post('registar', 'store')->name('movimentos.store');
    });

    Route::prefix('bombas')->controller(BombasController::class)->group(function () {
        Route::get('criar', 'create')->name('bombas.create');
        Route::get('lista', 'index')->name('bombas.list');
        Route::get('editar/{id}', 'update')->name('bombas.update');
        Route::get('reabastecer/{id}', 'refill')->name('bombas.refill');
        Route::get('reabastecer/lista/{id}', 'refillIndex')->name('bombas.refill.index')->withoutMiddleware('menus.access');
        Route::get('estado/{id}/{state}', 'changeState')->name('bombas.state');
        Route::post('registar', 'store')->name('bombas.store')->withoutMiddleware('menus.access');
        Route::post('reabastecer/registar/{id}', 'storeRefill')->name('bombas.refill.store')->withoutMiddleware('menus.access');
        Route::post('salvar/{id}', 'put')->name('bombas.put')->withoutMiddleware('menus.access');
        Route::post('eliminar/{id}', 'delete')->name('bombas.delete');
    });

    Route::prefix('hst-requisicao')->controller(HSTRequisicaoController::class)->group(function () {
        Route::get('criar', 'alocar')->name('hst-requisicao.alocar');
        Route::get('lista', 'index')->name('hst-requisicao.list');
        Route::post('registar', 'store')->name('hst-requisicao.store')->withoutMiddleware('menus.access');
    });

    Route::prefix('pecas')->controller(PecaController::class)->group(function () {
        Route::get('criar', 'create')->name('pecas.create');
        Route::get('lista', 'index')->name('pecas.list');
        Route::get('editar/{id}', 'update')->name('pecas.update');
        Route::post('registar', 'store')->name('pecas.store')->withoutMiddleware('menus.access');
        Route::post('salvar/{id}', 'put')->name('pecas.put')->withoutMiddleware('menus.access');
        Route::post('eliminar/{id}', 'delete')->name('pecas.delete');
    });

    Route::prefix('inventario')->controller(InventarioController::class)->group(function () {
        Route::get('entrada', 'create')->name('inventario.create');
        Route::get('lista', 'index')->name('inventario.list');
        Route::get('editar/{id}', 'update')->name('inventario.update');
        Route::get('adicionar-entrada', 'addEntrada')->name('inventario.addToEntradas')->withoutMiddleware('menus.access');
        Route::get('remover-entrada', 'removeEntrada')->name('inventario.removeFromEntradas')->withoutMiddleware('menus.access');
        Route::post('registar', 'store')->name('inventario.store')->withoutMiddleware('menus.access');
        Route::post('salvar/{id}', 'put')->name('inventario.put')->withoutMiddleware('menus.access');
        Route::post('eliminar/{id}', 'delete')->name('inventario.delete');
    });

    Route::prefix('utilizador')->controller(UtilizadoresController::class)->group(function () {
        Route::get('criar', 'create')->name('utilizador.create');
        Route::get('lista', 'index')->name('utilizador.list');
        Route::get('editar/{id}', 'update')->name('utilizador.update');
        Route::get('perfil/editar/{id}', 'updateProfile')->name('utilizador.profile.update')->withoutMiddleware('menus.access');
        Route::get('estado/{id}/{state}', 'changeState')->name('utilizador.state');
        Route::post('registar', 'store')->name('utilizador.store')->withoutMiddleware('menus.access');
        Route::post('perfil/registar', 'storeOrPutPessoa')->name('utilizador.pessoa.store')->withoutMiddleware('menus.access');
        Route::post('perfil/salvar', 'putPerfil')->name('utilizador.profile.put')->withoutMiddleware('menus.access');
        Route::post('salvar/{id}/{user_role}', 'put')->name('utilizador.put')->withoutMiddleware('menus.access');
        Route::post('eliminar/{id}/{user_role}', 'delete')->name('utilizador.delete');
    });

    Route::prefix('permissoes')->controller(PermissoesController::class)->group(function () {
        Route::get('criar', 'create')->name('permissoes.create');
        Route::get('lista', 'index')->name('permissoes.list');
        Route::get('editar/{id}', 'update')->name('permissoes.update');
        Route::get('gestao/{id}', 'manage')->name('permissoes.manage');
        Route::post('registar', 'store')->name('permissoes.store')->withoutMiddleware('menus.access');
        Route::post('salvar/{id}', 'put')->name('permissoes.put')->withoutMiddleware('menus.access');
        Route::post('gestao/salvar/{id}', 'putManage')->name('permissoes.manage.put')->withoutMiddleware('menus.access');
        Route::post('eliminar/{id}', 'delete')->name('permissoes.delete');
    });

    Route::prefix('requisicao')->controller(RequisicaoController::class)->group(function () {
        Route::get('detalhes/{client}/{requisicao}', 'show')->name('requisicao.show');
        Route::get('lista', 'index')->name('requisicao.list');
        Route::get('resposta/{id}', 'answer')->name('requisicao.answer');
        Route::post('eliminar/{id}', 'delete')->name('requisicao.delete');
        Route::post('resposta/enviar/{id}', 'send')->name('requisicao.send')->withoutMiddleware('menus.access');
    });

    Route::prefix('ocorrencia')->controller(OcorrenciaController::class)->group(function () {
        Route::get('criar', 'create')->name('ocorrencia.create');
        Route::get('movimento/criar/{viatura}/{motorista}/{movimento}', 'createFromMovimento')->name('ocorrencia.movimento.create')->withoutMiddleware('menus.access');
        Route::get('lista', 'index')->name('ocorrencia.list');
        Route::get('editar/{id}', 'update')->name('ocorrencia.update');
        Route::get('job-card/{ocorrencia}', 'jobCard')->name('ocorrencia.job-card');
        Route::post('registar', 'store')->name('ocorrencia.store')->withoutMiddleware('menus.access');
        Route::post('movimento/registar/{movimento}', 'storeFromMovimento')->name('ocorrencia.movimento.store')->withoutMiddleware('menus.access');
        Route::post('salvar/{id}', 'put')->name('ocorrencia.put')->withoutMiddleware('menus.access');
        Route::post('eliminar/{id}', 'delete')->name('ocorrencia.delete');
    });

    Route::prefix('job-card')->controller(JobCardController::class)->group(function () {
        Route::get('criar/{ocorrencia?}', 'create')->name('job-card.create');
        Route::get('detalhes/{id}', 'show')->name('job-card.show');
        Route::get('editar/{id}', 'update')->name('job-card.update');
        Route::get('lista', 'index')->name('job-card.list');
        Route::get('trabalhos/{id}', 'jobs')->name('job-card.jobs');
        Route::get('adicionar-trabalho', 'addJob')->name('job-card.addToJobs')->withoutMiddleware('menus.access');
        Route::get('remover-trabalho', 'removeJob')->name('job-card.removeFromJobs')->withoutMiddleware('menus.access');
        Route::post('registar/{ocorrencia?}', 'store')->name('job-card.store')->withoutMiddleware('menus.access');
        Route::post('trabalhos/registar/{id}', 'storeJobs')->name('job-card.jobs.store')->withoutMiddleware('menus.access');
        Route::post('salvar/{id}', 'put')->name('job-card.put')->withoutMiddleware('menus.access');
        Route::post('eliminar/{id}', 'delete')->name('job-card.delete');
    });

    Route::prefix('tecnico')->controller(TecnicoController::class)->group(function () {
        Route::get('criar', 'create')->name('tecnico.create');
        Route::get('editar/{id}', 'update')->name('tecnico.update');
        Route::get('lista', 'index')->name('tecnico.list');
        Route::post('registar', 'store')->name('tecnico.store')->withoutMiddleware('menus.access');
        Route::post('salvar/{id}', 'put')->name('tecnico.put')->withoutMiddleware('menus.access');
        Route::post('eliminar/{id}', 'delete')->name('tecnico.delete');
    });

    Route::prefix('notificacoes')->controller(NotificationController::class)->group(function () {
        Route::get('todas', 'index')->name('notificacao.list')->withoutMiddleware('menus.access');
        Route::get('marcar-como-lida/{id}', 'markRead')->name('notificacao.read')->withoutMiddleware('menus.access');
        Route::get('marcar-todas-lidas', 'markAllRead')->name('notificacao.read.all')->withoutMiddleware('menus.access');
    });

    Route::prefix('definicoes')->controller(SettingsController::class)->group(function () {
        Route::get('', 'show')->name('definicoes.show')->withoutMiddleware('menus.access');
        Route::post('salvar', 'store')->name('definicoes.store')->withoutMiddleware('menus.access');
        Route::post('aparencia/salvar', 'storeAppearance')->name('definicoes.appearance.store')->withoutMiddleware('menus.access');
    });
